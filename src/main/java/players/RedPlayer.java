    ...
    */
    ...
    public void move(int steps) {
        if (position + steps < board.length) {
            ...
            System.out.println("That roll was too great, you overshot. You must land on R3 (End)");
    ...
    public boolean hasWon() {
        return board[position].equals("R3 (End)"); //AMEND THESE TO SOMETHING LIKE board[board.length] SO VALUE NOT HARDCODED
    }
    @Override
